...
public enum ModArmorMaterials implements ArmorMaterial {
    ARMORED_ELYTRA("armored_elytra", 26, new int[]{ 3, 6, 8, 3 }, 10,
            SoundEvents.ARMOR_EQUIP_ELYTRA, 0f, 0f,
            () -> Ingredient.of(ModItems.FOSSILIZED_SCALE.get()));
    ...
    public String getName() {
        return CoolerEnd.MOD_ID + ":" + this.name;
    }
